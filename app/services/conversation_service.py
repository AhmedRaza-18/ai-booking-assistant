...
class ConversationManager:
    ...
    def determine_next_state(
        ...
        # COLLECT_NAME → COLLECT_PHONE (extraction happens in chat.py)
        if current_state == ConversationState.COLLECT_NAME:
            return ConversationState.COLLECT_PHONE

        # COLLECT_PHONE → COLLECT_DOB (extraction happens in chat.py)
        if current_state == ConversationState.COLLECT_PHONE:
            return ConversationState.COLLECT_DOB

        # COLLECT_DOB → COLLECT_INSURANCE (extraction happens in chat.py)
    ...
    def get_state_prompt(
        ...
        """
        Returns the AI prompt for each state
        """
